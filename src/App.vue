...
<div class="min-h-full">
   ...
   <nav id="nav" class=" shadow bg-gray-900">
        <div class="container px-6 py-3 mx-auto md:flex">
            ...
            <img class="h-8 w-8" src="https://router.vuejs.org/logo.png" alt="Workflow">
          </div>
                ...
                <div class="flex md:hidden" >
                    ...
                    <button @click="toggle" type="button"  class="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu">
            ...
            <div :class="open ? 'block': 'hidden'" class="w-full md:flex md:items-center md:justify-between">
                ...
                <div class="relative" >
                    ...
                    <div class="flex items-center py-2 -mx-1 md:mx-0"   v-if="auth">
                           ...
                           <RouterLink @click="logout" to="/register " class="block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-red-500 rounded-md hover:bg-red-600 md:mx-0 md:w-auto">Logout</RouterLink>
                        
                    </div>

                    <div class="flex items-center py-2 -mx-1 md:mx-0"   v-else="auth" >                                               
                          <RouterLink to="/login" class="block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-gray-500 rounded-md hover:bg-blue-600 md:mx-2 md:w-auto">Login</RouterLink>
                          <RouterLink to="/register" class="block w-1/2 px-3 py-2 mx-1 text-sm font-medium leading-5 text-center text-white transition-colors duration-200 transform bg-blue-500 rounded-md hover:bg-blue-600 md:mx-0 md:w-auto" >Register</RouterLink>
                    </div>
                </div>
